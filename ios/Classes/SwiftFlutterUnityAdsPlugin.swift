...
public class SwiftFlutterUnityAdsPlugin: NSObject, FlutterPlugin, UnityAdsDelegate {
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        ...
        let instance = SwiftFlutterUnityAdsPlugin(methodChannel: channel)
    ...
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        if (call.method == "getDebugMode") {
            ...
            if ((args["placementId"] as? String) != nil) {
